...
// CpopTokenContract is a free data retrieval call binding the contract method 0x0fe227d4.
//
// Solidity: function cpopTokenContract() view returns(address)
func (_Staking *StakingCaller) CpopTokenContract(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "cpopTokenContract")
...
//
// Solidity: function cpopTokenContract() view returns(address)
func (_Staking *StakingSession) CpopTokenContract() (common.Address, error) {
	return _Staking.Contract.CpopTokenContract(&_Staking.CallOpts)
}

// CpopTokenContract is a free data retrieval call binding the contract method 0x0fe227d4.
//
// Solidity: function cpopTokenContract() view returns(address)
func (_Staking *StakingCallerSession) CpopTokenContract() (common.Address, error) {
	return _Staking.Contract.CpopTokenContract(&_Staking.CallOpts)
}
...
// BatchStake is a paid mutator transaction binding the contract method 0xc2127793.
//
// Solidity: function batchStake(uint256[] tokenIds) returns()
func (_Staking *StakingTransactor) BatchStake(opts *bind.TransactOpts, tokenIds []*big.Int) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "batchStake", tokenIds)
}

// BatchStake is a paid mutator transaction binding the contract method 0xc2127793.
//
// Solidity: function batchStake(uint256[] tokenIds) returns()
func (_Staking *StakingSession) BatchStake(tokenIds []*big.Int) (*types.Transaction, error) {
	return _Staking.Contract.BatchStake(&_Staking.TransactOpts, tokenIds)
}

// BatchStake is a paid mutator transaction binding the contract method 0xc2127793.
//
// Solidity: function batchStake(uint256[] tokenIds) returns()
func (_Staking *StakingTransactorSession) BatchStake(tokenIds []*big.Int) (*types.Transaction, error) {
	return _Staking.Contract.BatchStake(&_Staking.TransactOpts, tokenIds)
}
...
//
// Solidity: function initialize(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract, address _owner) returns()
func (_Staking *StakingTransactor) Initialize(opts *bind.TransactOpts, _cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address, _owner common.Address) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "initialize", _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract, address _owner) returns()
func (_Staking *StakingSession) Initialize(_cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address, _owner common.Address) (*types.Transaction, error) {
	return _Staking.Contract.Initialize(&_Staking.TransactOpts, _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract, address _owner) returns()
func (_Staking *StakingTransactorSession) Initialize(_cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address, _owner common.Address) (*types.Transaction, error) {
	return _Staking.Contract.Initialize(&_Staking.TransactOpts, _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract, _owner)
}
...
func (_Staking *StakingTransactor) Stake(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "stake", tokenId)
}

// Stake is a paid mutator transaction binding the contract method 0xa694fc3a.
//
// Solidity: function stake(uint256 tokenId) returns()
func (_Staking *StakingSession) Stake(tokenId *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.Stake(&_Staking.TransactOpts, tokenId)
}

// Stake is a paid mutator transaction binding the contract method 0xa694fc3a.
//
// Solidity: function stake(uint256 tokenId) returns()
func (_Staking *StakingTransactorSession) Stake(tokenId *big.Int) (*types.Transaction, error) {
	return _Staking.Contract.Stake(&_Staking.TransactOpts, tokenId)
}
...
//
// Solidity: function updateContracts(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract) returns()
func (_Staking *StakingTransactor) UpdateContracts(opts *bind.TransactOpts, _cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address) (*types.Transaction, error) {
	return _Staking.contract.Transact(opts, "updateContracts", _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract)
}

// UpdateContracts is a paid mutator transaction binding the contract method 0x0b751279.
//
// Solidity: function updateContracts(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract) returns()
func (_Staking *StakingSession) UpdateContracts(_cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address) (*types.Transaction, error) {
	return _Staking.Contract.UpdateContracts(&_Staking.TransactOpts, _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract)
}

// UpdateContracts is a paid mutator transaction binding the contract method 0x0b751279.
//
// Solidity: function updateContracts(address _cpnftContract, address _cpopTokenContract, address _accountManagerContract, address _configContract) returns()
func (_Staking *StakingTransactorSession) UpdateContracts(_cpnftContract common.Address, _cpopTokenContract common.Address, _accountManagerContract common.Address, _configContract common.Address) (*types.Transaction, error) {
	return _Staking.Contract.UpdateContracts(&_Staking.TransactOpts, _cpnftContract, _cpopTokenContract, _accountManagerContract, _configContract)
}
