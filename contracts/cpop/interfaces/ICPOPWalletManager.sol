...
/**
 * @title ICPOPWalletManager
 * @notice Interface for CPOP Wallet Manager - creates AA wallets for Web2 users
 * @dev Factory pattern for creating CPOPAccount instances with deterministic addresses
 */
interface ICPOPWalletManager {
    /**
     * @notice Emitted when a new CPOP account is created
    ...
    /**
     * @notice Create a new CPOP account
    ...
    /**
     * @notice Create a CPOP account using a string identifier
    ...
    /**
     * @notice Create a CPOP account for Web2 users with master signer
     ...
     * @return The address of the CPOPAccount implementation
     */
     ...
     */
    function initialize(address entryPoint, address cpopToken, address owner) external;
