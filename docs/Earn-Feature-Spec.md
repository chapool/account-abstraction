...
```
USDT = 5,000，veCPOT boost = 200 bps，NFT boost = 0 bps

加权USDT = 5,000 × (10000 + 200) / 10000 = 5,100

每日CPP = 8.267 × (5,100 / 1,000,000) × 86,400 = 3,641 CPP/天
每月CPP = 3,641 × 30 = 109,230 CPP
月参考价值 = 109,230 × 0.002 ≈ 218.5 USDT
等效月化率 ≈ 4.37%（年化约 52.4%）
```

---

#### 用户 C — 大额存款，锁仓 360 天 + NFT SS 级

```
USDT = 50,000，veCPOT boost = 500 bps，NFT boost = 350 bps，合计 850 bps
...
#### 用户 D — 中等存款，锁仓 180 天 + NFT A 级

```
USDT = 10,000，veCPOT boost = 350 bps，NFT boost = 100 bps，合计 450 bps

加权USDT = 10,000 × (10000 + 450) / 10000 = 10,450

每日CPP = 8.267 × (10,450 / 1,000,000) × 86,400 = 7,458 CPP/天
每月CPP = 7,458 × 30 = 223,740 CPP
月参考价值 = 223,740 × 0.002 ≈ 447.5 USDT
等效月化率 ≈ 4.47%（年化约 53.7%）
```
...
| 用户 | USDT 存款 | CPOT 锁仓 | NFT 等级 | 加权USDT | 每日 CPP | 每月 CPP | 月参考价值(USDT) | 等效月化率 |
|-----|---------|---------|--------|---------|--------|--------|----------------|----------|
| A | 500 | 无 | 无 | 500 | 357 | 10,710 | 21.4 | 4.28% |
| B | 5,000 | 90天 | 无 | 5,100 | 3,641 | 109,230 | 218.5 | 4.37% |
| C | 50,000 | 360天 | SS | 54,250 | 38,720 | 1,161,600 | 2,323 | 4.65% |
| D | 10,000 | 180天 | A | 10,450 | 7,458 | 223,740 | 447.5 | 4.47% |
